...
public class PakaianAdapter extends RecyclerView.Adapter<PakaianAdapter.PakaianViewHolder> {
    ...
    int images[];
    Context context;
    public PakaianAdapter(Context ct, String s1[], String s2[], String s3[], int  img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    public PakaianViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_pakaian, parent, false);
        return new PakaianViewHolder(view);
    }
    ...
    public class PakaianViewHolder extends RecyclerView.ViewHolder{
        TextView myText1, myText2, star;
        ImageView myImage;
        ConstraintLayout mainLayout;
        public PakaianViewHolder(View itemView) {
            super(itemView);
